...
exports.interpret = interpret = function(scope, list) {
  ...
  func = list[0].text;
  if (scope[func] != null) {
    return prelude.call(scope, [null].concat(__slice.call(list)));
...
exports.start = function(srcpath) {
  ...
  require('./prelude').reloading.on('reload', function(frompath) {
    var info, time;
  ...
  return fs.watchFile(srcpath, {
    ...
    return require('./prelude').reloading.emit('reload', srcpath);
  });
};
