...
var error, fs, log_error, main, parse, path, print, stringify, type, _ref,
  __slice = [].slice;
...
exports.prelude = {
  ...
  bool: function(scope, list) {
    ...
    x = list[1];
    if ((_ref1 = x.text) === 'yes' || _ref1 === 'true' || _ref1 === 'on' || _ref1 === 'ok' || _ref1 === 'right') {
      return true;
    } else if ((_ref2 = x.text) === 'no' || _ref2 === 'false' || _ref2 === 'off' || _ref2 === 'wrong') {
      return false;
    } else {
