...
var error, fs, log_error, main, ms, parse, path, pretty, print, stringify, type, util, _ref, _ref1;
...
_ref1 = require('./tool'), type = _ref1.type, print = _ref1.print, stringify = _ref1.stringify, pretty = _ref1.pretty;
...
exports.prelude = {
  ...
  assert: function(scope, list) {
    var note, value;
    if (!((list[1] != null) && (list[2] != null))) {
      log_error(list[0], 'need two args');
    }
...
exports.prelude.require = function(scope, list) {
  var module_path;
  if ((type(list[1])) !== 'object') {
    log_error(list[0], 'need argument in string');
  }
  if (list[1] == null) {
    log_error(list[0], 'need a path');
  }
